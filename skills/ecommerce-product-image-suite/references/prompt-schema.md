...
`suite_prompt` 必须说明：同一产品外观、同一店铺风格、同一色调、同一视觉质量；除第 2 张为 `1:1` 外，其余 `3:4`；英阿双语同等重要；可使用厂家参考图；如参考图已提供，不要手写产品颜色和形状细节；人物可使用 Gemini 式明亮时尚大片和更强吸引力，但最终提示词要优先用 `高级女性美 / 成熟吸引力 / 健康丰腴 / 自然曲线 / 得体合身剪裁 / 明亮商业人像` 等 GPT Image 2 友好表达，不能色情低俗，产品必须是主角。
...
性感流量图的内部意图可以是“更有吸引力”，但最终提示词优先写成高级审美语言：成年女性角色、成熟气质、高级女性美、自然曲线、肩颈舒展、腰线自然、剪裁合身、材质柔软有质感、明亮商业摄影、时尚 editorial。禁止露点、透视裸露、明显性行为姿势、色情低俗和人物压过产品。

如果成图平台拦截或失败，优先按 `gpt-image2-safe-aesthetic.md` 降级：删除性感、诱惑、挑逗、胸、臀、低机位、湿身、暧昧等词，替换为成熟、优雅、健康、自信、自然曲线、高级女性美、商业人像、得体服装；保留修身材质、清透光线、高明度色彩和真实使用动作。
