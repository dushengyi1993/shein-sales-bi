...
人物可以年轻、漂亮、性感、有吸引力、轻微魅惑，适度露肤和擦边允许使用；但必须高级、干净、时尚，不色情低俗，不让人物抢走产品主体。
...
- SHEIN 默认保留 1 张 `1:1` 方形封面 + 12 张 `3:4`，主封面可以有少量清晰卖点符号。
- Amazon / noon 的主图必须走白底合规版：产品单体、纯白背景、无文字、无图标、无价格、无水印、无包装、无生活方式场景。
- 跨平台复用时，先生成平台合规主图，再把场景/卖点/参数信息放到二级图或后期合成图。
