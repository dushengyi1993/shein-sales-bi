...
- `shein-bi-daily-inventory-replenishment-guard.timer`：每天 `13:45` 在 `13:32–13:43` 全托首页之后执行，依赖当天 `morning-links-ready` 与 `13:12` 后的 `stock-refresh` marker，最晚 `14:17` 释放给 `14:20` ET 仓储费。对应 Codex 事后审计固定 `14:45`；计划/结果未生成只能报告未完成，不得写成0条或成功。
...
- `shein-bi-cloud-portal-section-queue.timer`：每小时 `:52` 给 pending section 一次低优先级机会，只能由正式 service 在 `:43–:59` 起跑。SSH 直接调用 worker 或在 `:00–:42` 手工启动 service 必须返回75，不得跨过下一次 `:32–:43` 全托首页保留车道；中断时 lease 回到 pending，旧 section 文件继续原子可读。
...
systemctl enable shein-bi-portal.service shein-bi-webhook.service shein-bi-cloud-morning-chain.timer shein-bi-cloud-morning-link-chunk-2.timer shein-bi-cloud-morning-supplements.timer shein-bi-cloud-yesterday.timer shein-bi-db-backup.timer shein-bi-cloud-order-closure.timer shein-bi-cloud-rtv-verify.timer shein-bi-daily-inventory-replenishment-guard.timer shein-bi-cloud-browser-cleanup.timer shein-bi-cloud-disk-maintenance.timer shein-bi-cloud-marketing-live-guard.timer shein-bi-cloud-marketing-repair.timer shein-bi-cloud-openapi-stock-refresh.timer shein-bi-cloud-today-sales-reconcile.timer shein-bi-cloud-portal-section-queue.timer shein-bi-cloud-manual-login-recovery.timer shein-bi-cloud-watchdog.timer
systemctl start shein-bi-portal.service shein-bi-webhook.service shein-bi-cloud-morning-chain.timer shein-bi-cloud-morning-link-chunk-2.timer shein-bi-cloud-morning-supplements.timer shein-bi-cloud-yesterday.timer shein-bi-db-backup.timer shein-bi-cloud-order-closure.timer shein-bi-cloud-rtv-verify.timer shein-bi-daily-inventory-replenishment-guard.timer shein-bi-cloud-browser-cleanup.timer shein-bi-cloud-disk-maintenance.timer shein-bi-cloud-marketing-live-guard.timer shein-bi-cloud-marketing-repair.timer shein-bi-cloud-openapi-stock-refresh.timer shein-bi-cloud-today-sales-reconcile.timer shein-bi-cloud-portal-section-queue.timer shein-bi-cloud-manual-login-recovery.timer shein-bi-cloud-watchdog.timer
