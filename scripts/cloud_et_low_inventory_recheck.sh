...
GUARD_ENV=(
  ...
  "SHEIN_BI_INVENTORY_JOURNAL_DIRS=${SHEIN_BI_INVENTORY_JOURNAL_DIRS:-/srv/shein-bi/runtime/daily-inventory-replenishment/results:/srv/shein-bi/runtime/daily-inventory-replenishment/runs:/srv/shein-bi/runtime/et-low-inventory-guard/results}"
