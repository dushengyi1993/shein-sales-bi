...
export async function planLinkOpsImageRoles({dir, cwd = process.cwd(), sourceApproved = null} = {}) {
  ...
  return {
    ...
    rules: {
      ...
      ignoredByName: '仅文件名明确包含“产品封面/AB测试”的图片按 AB 测试素材处理；“纯产品…旗舰封面”等正常主图名不因此排除。',
