...
export function highClickSpecialMetricSnapshot(row) {
  ...
  return {
    ...
    c7SaleCount,
    complete: c7Exposure !== null && c7ClickRate !== null && c7SaleCount !== null,
...
export function evaluateHighClickLowConversionRow(row, policy = DEFAULT_HIGH_CLICK_SPECIAL_POLICY) {
  ...
  if (!(metrics.c7Exposure > Number(cfg.c7ExposureMinExclusive))) {
    return {qualifies: false, reason: 'c7_exposure_not_above_threshold', metrics};
  }
  if (!(metrics.c7ClickRate > Number(cfg.c7ClickRateMinExclusive))) {
    return {qualifies: false, reason: 'c7_click_rate_not_above_threshold', metrics};
  }
  ...
  return {qualifies: true, reason: 'high_click_zero_sales', metrics};
}
