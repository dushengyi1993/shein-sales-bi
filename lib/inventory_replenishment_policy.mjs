...
export const INVENTORY_OVERWRITE_COMPUTATION_VERSION = 'locked-only/v1';
...
export function computeInventoryOverwriteQuantity(targetUsableInventory, stockRow = {}) {
  ...
  // Only an explicitly reported lock is durable unavailable inventory for the
  // daily VI overwrite. The total-versus-usable gap may be unexplained or
  // transient platform-side state; it is not a durable lock without evidence.
