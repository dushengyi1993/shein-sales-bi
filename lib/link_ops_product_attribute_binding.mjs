...
export const PRODUCT_ATTRIBUTE_BINDING_SCHEMA_VERSION = 1;
...
export function validateProductAttributeBindingLock(task, payload) {
  ...
  if (binding.schemaVersion !== PRODUCT_ATTRIBUTE_BINDING_SCHEMA_VERSION) {
    blockers.push(bindingBlocker('PRODUCT_ATTRIBUTE_BINDING_SCHEMA_INVALID', '属性绑定 schemaVersion 无效'));
  }
  ...
  if (attributeId !== null && attributeValueId !== null && donorModelValue) {
    ...
    const recomputedRequestKey = productAttributeBindingRequestKey({
