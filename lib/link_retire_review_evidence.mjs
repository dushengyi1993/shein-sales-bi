...
export const STORES = ['CX','DL','DX','FY','HL','HY','JSH','JY','LG','LQ','MZ','NM','QH','QY','TS','TZ','TZZ','XC','XL','YJ','ZL'];
export const EVIDENCE_SCHEMA_VERSION = 'link-retire-evidence/v1';
// Resolved once from lib/production_cloud_host.mjs; the collector records the
// host it was actually reached through, and this is the default expectation.
export const EVIDENCE_HOST = resolveProductionCloudHost();
