...
export function resolveFixedTierPrice(row, context) {
  ...
  const evidence = {key:key(row),canonical:item.canonical,reportDate:context.reportDate,metrics,age,newListing:recent,rank,ranking,...(rankBounds?{rankBounds}:{}),cost,exception:exception || null};
