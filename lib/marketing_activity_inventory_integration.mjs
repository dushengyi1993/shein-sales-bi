...
export async function executeLimitedDiscountWithInventoryTransaction({
  ...
  const transaction = await executeInventoryAwareActivity({
    ...
    validateEnrollment: value => validateLimitedDiscountEnrollmentReadback(value, {rescue}),
  });
  return {
    ...transaction,
...
export function validateLimitedDiscountEnrollmentReadback(commandResult, {rescue} = {}) {
