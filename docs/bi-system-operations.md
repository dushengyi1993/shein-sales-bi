...
> 当前权威状态：2026-05-06。本文只保留接手和日常运维需要的信息；历史排障过程见 `.codex/plans/2026-05-01T14-11-55-shein-link-management-system.md`。
...
- 当前 BI 截面日期：销售/订单 `2026-05-06`，售后/库存/财务业务日 `2026-05-05`，链接表现日 `2026-05-05`。
- 当前 BI 门户侧栏更新时间口径：销售取销售源数据抓取时间；售后/库存/财务取业务域源文件最大 `fetchTime`（当前 `2026-05-06 05:46:42`）；链接表现取链接源文件最大 `fetchTime`（当前 `2026-05-06 05:37:48`）。BI 入仓或页面重跑时间只作内部排障，不作为侧栏主要更新时间。
...
| 07:00 | `SHEIN-BI-Daily-Pipeline-0700` | 刷新 PostgreSQL BI 仓库、BI 体检、本地门户和 Markdown 晨报。`2026-05-06 07:00:01` 正式自动运行成功；下一次运行 `2026-05-07 07:00:00`。 |
...
- `2026-05-05` 早晨 Docker / WSL 文件系统异常已手动恢复；`2026-05-06 05:30` 链接/业务域任务和 `2026-05-06 07:00` BI 任务已正式自动跑通。下一次例行观察点为 `2026-05-07 05:30` 与 `2026-05-07 07:00`。
