...
人物风格允许更有流量感：年轻、漂亮、性感、有吸引力、轻微魅惑，适度露肤和擦边可以使用；但必须保持高级、干净、时尚，不色情、不低俗、不让人物抢走产品主体。欧洲市场可略微更开放，沙特市场要控制在 SHEIN 可过审的边界内。
...
如平台或类目需要更严主图，可额外生成“白底合规主图”作为替换封面，不占默认 13 张。Amazon / noon 主图必须走白底合规版：产品单体、纯白背景、无文字、无图标、无包装、无生活方式场景。
...
```text
请为同一个产品生成 13 张 SHEIN 电商产品图。所有图片保持同一产品外观、同一店铺风格、同一色调和同一视觉质量；每张图的主题不同，不要重复构图。除第 2 张为 1:1，其余均为 3:4。英文和阿文同等重要，文字必须清晰、准确、手机端可读。产品参考图是外观唯一依据，不得改变产品形状、颜色、接口、配件和比例。人物风格可以高级性感、有吸引力、轻微魅惑，但不能色情低俗，产品必须始终是主角。
```
...
- 需要流量感时，可加入“高级性感美女/轻微魅惑/适当露肤/时尚姿态”，但必须避免色情低俗、低质擦边和人物压过产品。
