...
- 2026-07-30 起，DL 单一 App 下的 19 店共享商品详情额度：商品列表和库存每天全量读取，`spu-info` 详情按每店 16 条轮转并优先补上次失败项，其余使用 21 天内最近成功详情；实时上下架仍由 Webhook 与业务域更新。禁止恢复“19 店并发全量详情”造成 `832213` 限流风暴。
