...
> 状态：本文保留 2026-06-28 至 2026-07-18 的原始设计、迁移理由和当时双跑边界，不是当前生产事实源说明。当前半托销售/Webhook 见 [实时切换记录](bi-webhook-live-cutover-2026-07-23.md)，当前 19 店授权拓扑见 [独立应用切回记录](openapi-per-store-production-cutback-2026-07-30.md)，生产 runbook 见 [cloud-bi-operations.md](cloud-bi-operations.md)。本文不保存任何 SHEIN 账号、密码、APP_SECRET、openKeyId、secretKey、tempToken 或 Cookie。
