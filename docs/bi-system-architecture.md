...
- `2026-05-06 07:00:01` 正式自动任务已运行成功；后续 `2026-05-06 08:10` / `10:10` 销售滚动后置 BI 也已成功刷新。下一次例行自动验证为 `2026-05-07 07:00`。
...
当前 BI 仓库已经按 15 店写入 `2026-05-06` 销售截面，业务域和链接表现为前一完整业务日 `2026-05-05`：
