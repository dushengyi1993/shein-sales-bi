...
- 云端执行 `node scripts/check_release_source_state.mjs --expected-commit 2026.08.03.6 --record-deployment 2026.08.03.6` 并取得 `ok=true`。
- 回滚点为 `2026.08.03.5`；回滚前确认没有活动库存事务处于临时补量窗口。
